...
process.env.BULK_ASSIGN_ENABLED = "true";
process.env.BULK_TICKET_IMPORT_ENABLED = "true";
...
beforeAll(async () => {
  if (!process.env.DATABASE_URL) {
    console.warn("[platform-validation-setup] DATABASE_URL not set — platform-validation tests will be skipped");
    return;
  }
